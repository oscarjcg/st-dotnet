...
namespace st_dotnet.Migrations
{
    ...
    [Migration("20221027192946_create_channel_types")]
    partial class create_channel_types
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("st_dotnet.Models.ChannelType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryChannel", b =>
                {
                    b.HasOne("st_dotnet.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("st_dotnet.Models.Channel", null)
                        .WithMany()
